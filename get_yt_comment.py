...
videoId = "a2y4_eOOn_Y"  # video of interest: sleeping position
...
def get_comments(part="snippet",
    ...
    comments, commentsId, authorurls, authornames, repliesCount, likesCount, viewerRating, dates, vidIds, vidTitles = [
    ], [], [], [], [], [], [], [], [], []
